          ...
          <div className={`container ${Classes.row}`}>
            ...
            <div className={Classes.flexItem}>
              <h4 className={Classes.aboutText}>
                ...
                laboriosam tenetur illum? Lorem ipsum dolor sit, amet
                consectetur adipisicing elit. Accusantium laboriosam quo quam
                quibusdam vitae fugiat sunt reprehenderit distinctio perferendis
                quod magnam excepturi tempore, sapiente aperiam! Explicabo odio
                neque molestiae quae eius dolore? Nesciunt neque facilis dolores
